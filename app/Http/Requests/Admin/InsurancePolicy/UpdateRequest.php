...
class UpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'policy_code' => ['required', 'string', 'max:20', 'regex:/^[A-Z0-9_-]+$/', Rule::unique('insurance_policies', 'policy_code')->where('insurance_company_id', $this->input('insurance_company_id'))->ignore($policy)],
    ...
    protected function prepareForValidation(): void
    {
        $this->merge([
            ...
            'version' => Str::squish((string) $this->input('version')),
        ]);
    }
}
